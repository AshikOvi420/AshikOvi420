...
public class buyride extends JFrame {
	 ...
	 * Create the frame.
	 */
	public buyride(String s,String s2,String s3,String s4) {
		...
		JButton btnNewButton = new JButton("H.HAMD");
		...
		btnNewButton.setBounds(0, 68, 352, 105);
		panel_3.add(btnNewButton);
		
		JLabel b1 = new JLabel(a+"                   "+b+"                     "+c+"                       "+d);
		b1.setForeground(new Color(95, 158, 160));
		b1.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 36));
		b1.setBounds(71, 287, 1086, 47);
		panel_3.add(b1);
		...
		btnNewButton_1.setBounds(1216, 287, 89, 45);
